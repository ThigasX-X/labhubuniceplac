...
// Verifica mensagens vindas da URL
if (isset($_GET['msg'])) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // --- SEGURANÇA: Usando password_verify para comparar com a Hash do banco ---
    if ($usuario && password_verify($senha_digitada, $usuario['senha'])) {

        if ($usuario['email_verificado'] == 0) {
            $erro = "Seu acesso está bloqueado. Por favor, confirme seu e-mail.";
        } else {
            // SEGURANÇA EXTRA: Gera um novo ID de sessão para evitar sequestro de sessão
