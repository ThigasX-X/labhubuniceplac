...
class AgendamentoDAOImpl implements AgendamentoDAO
{
    ...
    {
        return $this->pdo->query("SELECT id, nome, capacidade FROM laboratorios ORDER BY nome")->fetchAll(PDO::FETCH_ASSOC);
    }
    ...
    {
        return $this->pdo->query("SELECT id, nome FROM disciplinas ORDER BY nome")->fetchAll(PDO::FETCH_ASSOC);
    }
